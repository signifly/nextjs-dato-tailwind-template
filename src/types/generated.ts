...
export type PageContentQueryQueryVariables = Exact<{
  locale?: InputMaybe<SiteLocale>
}>

export type PageContentQueryQuery = {
  __typename?: 'Query'
  site: {
    __typename?: 'Site'
    favicon: Array<{
...
export const PageContentQueryDocument = {
  kind: 'Document',
  definitions: [
    {
  ...
  PageContentQueryQuery,
  PageContentQueryQueryVariables
>
